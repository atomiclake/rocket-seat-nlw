...
using PassIn.Application.UseCases.Attendees.GetAllById;
...
public class AttendeesController : ControllerBase
{
    ...
    public IActionResult Register([FromRoute] Guid eventId, [FromBody] RequestRegisterEventJson request)
    {
        ...
        ResponseResourceRegisteredJson response = useCase.Execute(eventId, request);
    ...
    {
        var useCase = new GetAllAttendeesByIdUseCase();
